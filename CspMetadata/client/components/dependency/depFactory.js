...
angular.module('cspMetadataApp')
  .factory('dependencies', ['$http','Auth',function($http,Auth){
 ...
 //////////////////////////////////////////////*get all dependencies*////////////////////////////////////
    ...
    /*get all dependencies*/
    ob.getAll = function() {
        return $http.get('/api/certificate/dependencies')
          .success(function(res){

            angular.copy(res, ob.dependencies);
        });
    };
...
///////////////////////////////////////////!*upvote provider1-post-comment-reply*!////////////////////////////////////
    ...
    ob.upvotePost = function(provider, post) {
        /!*console.log("Calling upvotePost function on dependency.js")
    ...
    ob.upvoteComment = function(provider,post,comment) {
        //console.log("Calling upvoteComment function on dependency.js")
        //console.log("PROVIDER -> ", provider)
        //console.log("POST -> ", post)
    ...
    ob.upvoteReply = function(provider, post,comment,reply) {
        //console.log("Calling upvoteReply function on dependency.js")
